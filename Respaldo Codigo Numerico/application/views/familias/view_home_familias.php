...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<!--AJAX DE LA TABLA-->
		<?php include '/../../scripts/cargar_tabla_familias.php';?>
		<?php include '/../../scripts/ajax_familias.php';?>
		<!--CARGA DEL JQUERY-->
		...
		<script type="text/javascript" src="<?php echo base_url('application/scripts/familias_tools.js'); ?>"></script>
		<!--CARGA DE MODAL-->
