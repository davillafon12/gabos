...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Usuario Deshabilitado</title>
	...
	<body >
		...
		<div class="main_wrapper">
			<p class="titulo_wrapper">Usuario Deshabilitado</p>
			<hr class="division_wrapper">
			<p class="contenido_wrapper">
				</br>Este usuario se encuentra desactivado y no podra realizar ninguna operación.</br>
