...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<?php echo base_url('application/scripts/clientes/autorizaciones.js'); ?>"></script>
	</head>
	<body >
		<?php
			if(isset($error)){
		...
		<div class="main_wrapper">
			...
			<div  class="contenido">
			<?php 
				$attributes = array('name' => 'editar_autorizaciones_form');
				echo form_open_multipart('clientes/autorizaciones/actualizar', $attributes); 
			?>
				...
				<hr class="division-contenido">
					...
					<fieldset class="persona-uno">
						...
						<table>
							<tr>
								...
								<td>
									<input id="cedula_persona_uno" class="input-campos" placeholder="Cédula de la persona autorizada" autocomplete="off" name="cedula_persona_uno" type="text" >
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input id="nombre_persona_uno" class="input-campos" placeholder="Nombre de la persona autorizada" autocomplete="off" name="nombre_persona_uno" type="text" >
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input id="apellido_persona_uno" class="input-campos" placeholder="Apellidos de la persona autorizada" autocomplete="off" name="apellido_persona_uno" type="text" >
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="file" class="input-campos" name="carta[]" size="10" accept="image/png">
								</td>
							</tr>
						</table>
					</fieldset>
					<fieldset class="persona-dos">
						...
						<table>
							<tr>
								...
								<td>
									<input id="cedula_persona_dos" class="input-campos" placeholder="Cédula de la persona autorizada" autocomplete="off" name="cedula_persona_dos" type="text" >
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input id="nombre_persona_dos" class="input-campos" placeholder="Nombre de la persona autorizada" autocomplete="off" name="nombre_persona_dos" type="text" >
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input id="apellido_persona_dos" class="input-campos" placeholder="Apellidos de la persona autorizada" autocomplete="off" name="apellido_persona_dos" type="text" >
								</td>
							</tr>
							<tr>
								<td>
					...
					<input class="button-submit" name="submit" id="submit" onsubmit="" tabindex="18" value="Actualizar" type="submit" >
				</form>
			</div>		
		</div>
		<!--Incluir footer-->
