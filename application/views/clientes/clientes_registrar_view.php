		...
		<div class="main_wrapper">
			...
			<tr>
				...
				<td>
					...
					<input id="essucursal" tabindex="11" type="checkbox" name="issucursal" value="1" style="position: relative; top: -5px;"> 	
					<label for="esexento" class="labelMedium" style="position: relative; top: -5px;">Exento:</label>  
					<input id="esexento" tabindex="11" type="checkbox" name="esexento" value="1" style="position: relative; top: -5px;"> 	
					<label for="aplicaRetencion" class="labelMedium" style="position: relative; top: -5px;">Sin Retención:</label>  
					<input id="aplicaRetencion" tabindex="11" type="checkbox" name="aplicaRetencion" value="1" style="position: relative; top: -5px;" > 	
				</td>
