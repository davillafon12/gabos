...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Consulta de Notas Crédito</title>
		...
		<script type="text/javascript" src="<?php echo base_url('application/scripts/consulta/notas_credito_tools.js'); ?>"></script>
		<script>
	...
	<body>
		...
		<div class="main_wrapper">
			<p class="titulo_wrapper">Consulta de Notas Crédito</p>
			...
			<div class="contenedor">
				...
				<table id="tabla_productos" class="tabla_productos">
					<thead>
						...
						<th class="th_cantidad">Cant. Defectuoso</th>						
						<th class="th_descuento">Cant. Bueno</th>
