...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script src="<?php echo base_url('application/scripts/articulos/verifica_codigos_ingreso_individual.js'); ?>" type="text/javascript"></script>
		<!--CSS ESTILO ESPECIFICO DE LA PAG-->
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('application/styles/articulos/style_ingreso_individual.css'); ?>">
		<!--SCRIPT DE HERRAMIENTAS-->
		<script src="<?php echo base_url('application/scripts/articulos/ingreso_individual_tools.js'); ?>" type="text/javascript"></script>	
	</head>
	<body>
