			...
			?>	 
				...
				<tr>
					<td>
						...
						<input id="cedula_ju" autocomplete="off" name="cedula_ju" placeholder="Cédula Jurídica de la empresa" required="" tabindex="1" type="text"> 
					</td>
					<td>
						<p class="contact"><label for="name">Nombre:</label></p> 
						<input id="name" autocomplete="off" name="name" placeholder="Nombre de la empresa" required="" tabindex="2" type="text"> 
					</td>
				</tr>
				<tr>
					<td>
