...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="<?php echo base_url('application/scripts/bancos_editar_tools.js'); ?>"></script>
		<!--CARGA DE MODAL-->
		...
		<!--CARGA DE LA CARGA DE LA TABLA -->
		<script type="text/javascript" src="<?php echo base_url('application/scripts/bancos_cargar_table.js'); ?>"></script>
	</head>
	<body >
		...
		<div class="main_wrapper">
			<p class="titulo_wrapper">Bancos</p>
