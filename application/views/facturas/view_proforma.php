...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo base_url('application/styles/facturas/factura_nueva_style.css?v='.$javascript_cache_version); ?>">
				...
				for($contador=0;$contador<10;$contador++)
				{
					...
					echo "<tr id='articulo_".$numero_id."'>
							...
							<td class='contenedor-descripcion'>
								<input type='text' class='art-descripcion-guardado' id='desc_final_".$numero_id."' style='display:none;'  onkeyup='actualizarDescripcion(event)'/>
