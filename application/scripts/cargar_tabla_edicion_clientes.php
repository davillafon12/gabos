...
echo 
	"<script type='text/javascript'>
		...
		function getTable()
		{
			...
			getContentTable('".$Ruta_Base."clientes/editar/getMainTable', tabla);
		}
		/*Metodo encargado de cargar todos los datos de la tabla cliente*/
		function getTable2()
		{
			var tabla = document.getElementById('contenido');
			getContentTable2('".$Ruta_Base."clientes/editar/getMainTable2', tabla);
		}		
