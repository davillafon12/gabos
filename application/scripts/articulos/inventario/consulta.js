...
function descargar(){
    ...
    $.ajax({
        url: location.protocol+'//'+document.domain+(location.port ? ':'+location.port: '')+"/articulos/inventario/descarga?s="+_SUCURSAL_SELECCIONADA+"&c="+_CONSECUTIVO_CARGADO+"&t="+tipoArchivo,
        cache: false,
        xhr: function () {
        ...
        success: function (data) {
            var fileName = 'Control_Inventario_Sucursal_'+_SUCURSAL_SELECCIONADA+"_Consecutivo_"+_CONSECUTIVO_CARGADO+(tipoArchivo == "excel" ? ".xlsx" : ".pdf");
