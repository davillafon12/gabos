...
function imprimir(){
	...
	if(tipoImpresion==='t'){
		//Impresion termica
		window.open(servidorImpresion+'/index.html?t='+token+'&d=rp&n='+consecutivoActual+'&s='+sucursal+'&i='+tipoImpresion+'&server='+document.domain+'&protocol='+location.protocol,'Impresion de Facturas','width='+anchoImpresion+',height='+alturaImpresion+',resizable=no,toolbar=no,location=no,menubar=no');
