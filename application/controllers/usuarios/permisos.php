<?php
	...
	$permisosAdmin = array('activar_empresa', 'activar_familias', 'crear_factura', 'crear_proforma', 'desactivar_banco', 'desactivar_empresa', 'desactivar_familias', 'editar_autorizacion', 'editar_banco', 'editar_cliente', 'editar_codigo', 'editar_empresa', 'editar_familias', 'editar_usuarios', 'entrada_familias', 'entrar_banco', 'entrar_caja', 'entrar_empresa', 'otros_cliente', 'registrar_articulo', 'registrar_articulos_masivo', 'registrar_banco', 'registrar_cliente', 'registrar_empresa', 'ver_bitacora', 'entrar_recibos', 'ver_autorizacion', 'entrar_notas', 'anular_recibos', 'deposito_recibos', 'entrar_notas_d', 'crear_retiros', 'ingreso_bodega', 'registrar_familia', 'cambio_codigo_articulo','realizar_traspasos');
	$permisosAvanz = array('activar_empresa', 'activar_familias', 'crear_factura', 'crear_proforma', 'desactivar_banco', 'desactivar_empresa', 'desactivar_familias', 'editar_autorizacion', 'editar_banco', 'editar_cliente', 'editar_codigo', 'editar_empresa', 'editar_familias', 'editar_usuarios', 'entrada_familias', 'entrar_banco', 'entrar_caja', 'entrar_empresa', 'otros_cliente', 'registrar_banco', 'registrar_cliente', 'registrar_empresa', 'entrar_configuracion', 'ver_bitacora', 'entrar_recibos', 'ver_autorizacion', 'entrar_notas', 'anular_recibos', 'deposito_recibos', 'entrar_notas_d', 'crear_retiros', 'cambio_codigo_articulo','realizar_traspasos');
?>